Welcome to the MYsql GUI folder! This folder contains all the assets and files required to run the graphical user interface (GUI) for the data pipeline code. 
...
Data Pipeline.bat: This batch file is provided to easily run the Streamlit application that hosts the GUI interface.
...
Run the "Data Pipeline.bat" batch file to start the Streamlit application, which hosts the GUI.
